...
static var termos : Dictionary = {
	...
	# --- Ataques ---
	"EsferaAzul": [0, "Início"], "EsferaVermelha": [0, "Esfera Vermelha"], "Gelo": [0, "Gelo"], "Fogo": [0, "Fogo"], "ExplosaoFogo": [0, "Explosão de Fogo"], "ExplosaoGelo": [0, "Explosão de Gelo"], "Alho": [0, "Alho"], "Raio": [0, "Raio"],
